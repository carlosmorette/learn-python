...
colorBank = colors[2]["value"]
colorPlayer = colors[1]["value"]

print("{0}JOGO 21{0}".format(colors[0]["value"]))

print("{0}={0}".format(colors[3]["value"]) * 35)

firstCardBank = giveLetter()
print("{2}Primeira carta da banca: {0} de {1}{2}".format(firstCardBank["name"], firstCardBank["naipe"], colorBank))

print("{0}={0}".format(colors[3]["value"]) * 35)

firstCardPlayer = giveLetter()
print("{2}Sua primeira carta: {0} de {1}{2}".format(firstCardPlayer["name"], firstCardPlayer["naipe"], colorPlayer))
...
print("{2}Sua segunda carta: {0} de {1}{2}".format(secondCardPlayer["name"], secondCardPlayer["naipe"], colorPlayer))
